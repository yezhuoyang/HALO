...
def test_scheduling():
    ...
    process15 = generate_process_from_benchmark(benchmark_id=0, pid=15, shots=1000, share_qubit=True)
    process16 = generate_process_from_benchmark(benchmark_id=1, pid=16, shots=1000, share_qubit=True)
    process17 = generate_process_from_benchmark(benchmark_id=2, pid=17, shots=1000, share_qubit=True)
    process18 = generate_process_from_benchmark(benchmark_id=3, pid=18, shots=1000, share_qubit=True)
    process19 = generate_process_from_benchmark(benchmark_id=4, pid=19, shots=1000, share_qubit=True)
    process20 = generate_process_from_benchmark(benchmark_id=5, pid=20, shots=1000, share_qubit=True)
    process21 = generate_process_from_benchmark(benchmark_id=6, pid=21, shots=1000, share_qubit=True)
    ...
    scheduler.add_process(process15,source_id=0)
    scheduler.add_process(process16,source_id=1)
    scheduler.add_process(process17,source_id=2)
    scheduler.add_process(process18,source_id=3)
    scheduler.add_process(process19,source_id=4)
    scheduler.add_process(process20,source_id=5)
    scheduler.add_process(process21,source_id=6)
